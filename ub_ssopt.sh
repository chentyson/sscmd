...
sed -i '$a root soft nofile 51200' /etc/security/limits.conf 
sed -i '/hard nofile 51200/d' /etc/security/limits.conf
sed -i '$a * hard nofile 51200' /etc/security/limits.conf 
sed -i '$a root hard nofile 51200' /etc/security/limits.conf 
...
sed -i '$a net.ipv4.ip_local_port_range = 8000 65500' /etc/sysctl.conf
